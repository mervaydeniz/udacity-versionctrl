...
def get_filters():
    ...
    Returns:
        (str) city - name of the city to analyzee 
    ...
    while 1:
        choice = input('Do you want to filter the data by month and/or week? Please write Yes or No ').lower()
        print()
    ...
    while 1:
        if choice:
            filter=input('You can filter by month or day or both ').lower()
            print()
            if filter=='month':
                ...
                print('Which day or days data to look at? ')
                ...
                print('Which month or months data to look at?')
                month = input('January, February, March, April, May, June ').lower()
                print()
                if month not in MONTH_DATA:
                    print('Please enter a valid choice!')
...
def time_stats(df):
    ...
    print('Most common month for travel is {}'.format(most_freq_month))
    ...
    print('Most common day of week for travel is {}'.format(most_freq_day))

    # TO DO: display the most common start hour
    df['hour']=pd.to_datetime(df['Start Time']).dt.hour
    most_freq_hour = df['hour'].mode()[0]
    print('Most common hour for travel is {}'.format(most_freq_hour))
...
def trip_duration_stats(df):
    ...
    print('Travelled a total of {} days, {} hours, {} minutes and {} seconds'.format(sum_days, sum_hours, sum_minutes, sum_seconds))
    ...
    print('Travelled an average of {} hours, {} minutes and {} seconds'.format(mean_hours, mean_minutes, mean_seconds))
...
def user_stats(df):
    ...
    if 'Gender' not in df:
        ...
        print('counts of gender {}'.format(len(gender_of_users)))
    ...
    if 'Birth Year' not in df:
        print('Data for users birth years are not available for this city')
    else:
...
def display_data(df):
    choice = input('Do you want to read some of the raw data? Yes/No ').lower()
    print()
    if choice=='yes' or choice=='y':
        choice=True
    elif choice=='no' or choice=='n':
    ...
    if choice:
        while 1:
            for i in range(5):
                print(df.iloc[i])
                print()
            choice = input('More five data? Yes/No ').lower()
            if choice=='yes' or choice=='y':
                continue
            elif choice=='no' or choice=='n':
                break
